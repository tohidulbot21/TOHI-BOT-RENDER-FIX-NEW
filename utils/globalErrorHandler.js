class GlobalErrorHandler {
  ...
  logError(error, context = 'Unknown') {
    ...
    // Don't log rate limit, timeout, connection, or GraphQL errors to reduce spam
    if (!error.toString().includes('Rate limited') && 
        ...
        !error.toString().includes('getThreadInfoGraphQL') &&
        !error.toString().includes('Invalid response data') &&
        !error.toString().includes('formatThreadGraphQLResponse') &&
        error.error !== 3252001) {
